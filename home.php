...
if ($pesquisa) {
	$sql = "SELECT * FROM `anuncio_patente` where (`id` LIKE '%pesquisa%') or (`id_usuario` LIKE '%$pesquisa%') or (`titulo` LIKE '%$pesquisa%') or (`descricao` LIKE '%$pesquisa%') or (`telefone` LIKE '%$pesquisa%') or (`email_usuario` LIKE '%$pesquisa%') or (`data_inclusao` LIKE '%$pesquisa%') LIMIT $pagina, $itens_por_pagina";	
	$num_paginas_def = 1;
			...
			<div class="col-md-6">
				...
				<div class="container fluid">
					<div class="row">
						...
						<!--AINDA HÁ UM BUG QUE PAGINATION FICA MESMO COM 1 ANUNCIO(corrigido) E QUE QUANDO SELECIONA O SEGUNDO INDICE ELE VIRA UM SELECT ALL(corrigido)-->
						<!--MAIS UM BUG QUE QUANDO A PAGINA É ACIMA DE 2 ELA MOSTRA COMO SE FOSSE A 2 AINDA-->
						
						<?php if ($num > 9 || $pagina > 9) {
						...
						<nav aria-label="Page navigation">
							<ul class="pagination">
								...
								<li <?php echo $estilo; ?>><a href="home.php?<?php if(isset($pesquisa)){echo "pagina=".($i+10)."&input_pesquisa=".$pesquisa;}else{ echo $i;}?>"><?php echo $i+1; ?></a></li>
